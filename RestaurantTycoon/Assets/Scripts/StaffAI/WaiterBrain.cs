...
//Manages waiterNPC related processes; taking orders, finding customers, serving customers, etc.
public class WaiterBrain : MonoBehaviour
{
    ...
    void checkForTasks()
    {
        if (tasks.Count == 0)
        {
            ...
            {
                if (CustomerBase.customers[i].hasOrdered == false & CustomerBase.customers[i].isSitting == true)
                {
